...
pub fn cdp(it: *Interpreter, out: *Object, index: usize, v: Value) EvalError!?Completion {
...
pub fn numToKey(arena: std.mem.Allocator, k: usize) std.mem.Allocator.Error![]const u8 {
