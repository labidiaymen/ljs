...
pub fn callNative(self: *Interpreter, func: *Object, args: []const Value, this_val: Value) EvalError!Completion {
    ...
    switch (func.native) {
        ...
        .timer_fn, .console_log, .process_method, .buffer_fn, .events_method, .util_method, .qs_method, .assert_method, .url_method, .nodetest_method, .require_fn, .core_module_fn => unreachable, // HOST (spec 098/100/101/102/103/104/105/106) — handled in the first switch
