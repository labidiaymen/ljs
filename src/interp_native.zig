...
pub fn callNative(self: *Interpreter, func: *Object, args: []const Value, this_val: Value) EvalError!Completion {
    switch (func.native) {
        ...
        .timers_method => return @import("host_timers_mod.zig").method(self, func, args), // HOST timers/promises (spec 106)
        ...
        .stream_method => return @import("host_stream.zig").method(self, func, this_val, args), // HOST stream
        .string_decoder_method => return @import("host_string_decoder.zig").method(self, func, this_val, args), // HOST string_decoder
        .http_method => return @import("host_http.zig").method(self, func, this_val, args), // HOST http server
        ...
        .https_method => return @import("host_https.zig").method(self, func, this_val, args), // HOST https
        .eval_fn => {
