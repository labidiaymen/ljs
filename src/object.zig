...
pub const PrivateName = rt.PrivateName;
pub const PrivateEnv = rt.PrivateEnv;
...
pub const Object = struct {
    ...
    fn nativeLength(id: NativeId, name: []const u8) ?f64 {
        ...
        return switch (id) {
            ...
            // ── Math / Reflect ──
            .math_method => L.pick(name, .{ .{ "atan2", 2 }, .{ "pow", 2 }, .{ "max", 2 }, .{ "min", 2 }, .{ "hypot", 2 }, .{ "imul", 2 }, .{ "random", 0 } }) orelse 1,
