...
> `language/` **90.9%** (40,450 / 44,475) · `built-ins/` **53.4%** (25,111 / 46,981) ·
> **combined 71.7%** (65,561 / 91,456). The standard built-in library is where the remaining work
...
**Current (verified):** `language/` **90.9%** (40,450 / 44,475) · `built-ins/` **53.4%**
(25,111 / 46,981). The remaining `language/` ~9% is mostly runtime edge cases and a few
