...
> `language/` **91.3%** (40,602 / 44,475) · `built-ins/` **62.2%** (29,231 / 46,981) ·
> **combined 76.3%** (69,833 / 91,456). The standard built-in library is where the remaining work
...
**Current (verified):** `language/` **91.3%** (40,602 / 44,475) · `built-ins/` **62.2%**
(29,231 / 46,981). The remaining `language/` ~9% is mostly runtime edge cases and a few
